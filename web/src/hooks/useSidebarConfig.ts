...
const DEFAULT_PRIMARY_NAV: SidebarItem[] = [
  ...
  { id: 'logs', name: 'Logs', icon: 'FileText', href: '/logs', type: 'link', order: 17 },
  { id: 'network', name: 'Network', icon: 'Globe', href: '/network', type: 'link', order: 18 },
  { id: 'nodes', name: 'Nodes', icon: 'CircuitBoard', href: '/nodes', type: 'link', order: 19 },
  { id: 'operators', name: 'Operators', icon: 'Cog', href: '/operators', type: 'link', order: 20 },
  { id: 'pods', name: 'Pods', icon: 'Hexagon', href: '/pods', type: 'link', order: 21 },
  { id: 'security', name: 'Security', icon: 'Shield', href: '/security', type: 'link', order: 22 },
  { id: 'security-posture', name: 'Security Posture', icon: 'ShieldCheck', href: '/security-posture', type: 'link', order: 23 },
  { id: 'services', name: 'Services', icon: 'Network', href: '/services', type: 'link', order: 24 },
  { id: 'storage', name: 'Storage', icon: 'HardDrive', href: '/storage', type: 'link', order: 25 },
  { id: 'workloads', name: 'Workloads', icon: 'Box', href: '/workloads', type: 'link', order: 26 },
]
