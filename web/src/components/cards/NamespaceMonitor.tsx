...
export function NamespaceMonitor({ config: _config }: CardComponentProps) {
  ...
  const ResourceModal = () => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setModalResource(null)} role="button" tabIndex={0} onKeyDown={(e) => e.key === 'Escape' && setModalResource(null)}>
